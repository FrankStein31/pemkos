...
class EditTenantPresenter(private  val activity: Activity, private val view: EditTenantView) {
    ...
    fun editTenant(data: AddTenantRequest){
        try{
            Log.d("AbkPresenter", " id sekolah $data")
            subscription = apiServices.editTenant(data)
